...
export default class App extends React.Component<{}, AppState> {
    ...
    createMessages = () => {
        return this.state.messages.map((message: Message, index: number) =>
            <p key={index} className={message.sender !== this.state.userName ? 'message-list text-left' : 'message-list'}>
                {/* <img height="25px" src={message.sender !== this.state.userName ? user2Img : userImg} /> */}
    ...
    showTyping = () => {
        ...
        return isShowTyping ? <p className={this.state.isBotUser ? "typing-text text-left" : "typing-text"}>Typing...</p> : null
    }
